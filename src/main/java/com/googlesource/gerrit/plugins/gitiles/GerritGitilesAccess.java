...
class GerritGitilesAccess implements GitilesAccess {
  ...
  public Map<String, RepositoryDescription> listRepositories(
    ...
    lp.setFormat(OutputFormat.JSON);
    lp.setAll(true);
    ...
    try {
      ...
      Map<String, ProjectInfo> p = ((Map<String, ProjectInfo>) lp.apply(TopLevelResource.INSTANCE));
      projects = p;
    } catch (AuthException e) {
      ServiceNotAuthorizedException err = new ServiceNotAuthorizedException();
      err.initCause(e);
      throw err;
