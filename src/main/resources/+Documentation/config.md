...
Gitiles now provides it's own links through the weblinks extensions in Gerrit.
If you upgrade from older version of the Gitiles plugin, that uses the gitweb
