...
local_jar(
  ...
  jar = '$HOME/.m2/repository/com/google/gitiles/gitiles-servlet/0.1-8/gitiles-servlet-0.1-8.jar',
  src = '$HOME/.m2/repository/com/google/gitiles/gitiles-servlet/0.1-8/gitiles-servlet-0.1-8-sources.jar',
  deps = [':prettify']
)
